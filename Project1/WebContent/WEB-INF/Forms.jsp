                                ...
                                <div class="card-body">
                                    <form action="Forms" method="post"  data-parsley-validate="">
                                        <div class="form-group">
                                            ...
                                            <input id="inputUserName" type="text" name="username" data-parsley-trigger="change" name="username" placeholder="Enter user name" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail">Email</label>
                                            <input id="inputEmail" type="email" name="email" data-parsley-trigger="change" name="email" placeholder="Enter email" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="inputRepeatPassword">Num Telephone</label>
                                        ...
                                        <div class="form-group">
                                            <label for="inputRepeatPassword">Role</label><br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 pl-0">
                                                <p class="text-right">
                                                    <button type="submit" class="btn btn-space btn-primary" name="userInsert">Submit</button>
